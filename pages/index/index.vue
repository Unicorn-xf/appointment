<template>
	<view>
		<!-- <view class="header" style="background: #ED1C24"> -->
		<!-- 头部 -->
		<view class="place">
		</view>
		<view class="top">
		...
		<view class="scroll_box">
			<swiper class="swiper" circular="true" vertical="true" display-multiple-items="3" :autoplay="autoplay"
		...
		<view class="content" style="margin-top: 10rpx;margin-bottom: 50rpx;">
		...
		<view class="static">
			<view class="static-item" style="border-radius: 20upx 0 0 20upx;">
				<view class="static-item-type">预约客户</view>
			...
			<view class="static-item" style="border-radius:0 20upx 20upx 0;">
				<view class="static-item-type">预约额度</view>
				<view class="static-item-number">{{onTheDayJinE}}<span style="font-size: 24upx;">万元</span></view>
			</view>
		</view>
		<view class="static">
			<view class="static-item" style="border-radius: 20upx 0 0 20upx;">
				<view class="static-item-type">累计客户</view>
				<view class="static-item-number">{{clientnumleiji}}<span style="font-size: 24upx;">人</span></view>
			</view>
			<view class="static-item" style="border-radius:0 20upx 20upx 0;">
				<view class="static-item-type">累计额度</view>
		...
		methods: {
			...
			selectgoUpNoticeList() {
				...
				assessment.selectGoUpNoticeList({
					...
					if (res.result.retcode == "0000") {
						var data = res.result.data;
						this.clientnumleiji = data.length
						var info = [];
						var moneys = 0
						...
						this.leijijine = this.moneyFormat(parseInt(moneys))
